...
type UserEntityMapper() = 
    ...
    interface IMapper<UserDTO, User> with
        ...
        member __.Map(source : UserDTO, destination : User ref) = 
            if !destination = null then destination := User()
    ...
    member this.Map(source : UserDTO, destination : User ref) = 
        (this :> IMapper<UserDTO, User>).Map(source, destination)
...
type UserDTOMapper() = 
    ...
    interface IMapper<User, UserDTO> with
        ...
        member __.Map(source : User, destination : UserDTO ref) = 
            if !destination = null then destination := UserDTO()
    ...
    member this.Map(source : User, destination : UserDTO ref) = 
        (this :> IMapper<User, UserDTO>).Map(source, destination)
